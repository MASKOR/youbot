...
#include <youbot_actions/AveragingAction.h>
...
protected:
  ...
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<youbot_actions::AveragingAction> as_;
  std::string action_name_;
  int data_count_, goal_;
  float sum_, sum_sq_;
  youbot_actions::AveragingFeedback feedback_;
  youbot_actions::AveragingResult result_;
  ros::Subscriber sub_;
};
